...
export default function OneBraincell() {
    ...
    <div className={`h-screen w-screen bg-black ${showOutline ? 'outline' : ''}`}>
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          {/* Profile Picture */}
          <img
            src="../orange.png" // Placeholder image
            alt="Profile Picture"
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">One Orange Braincell</h2>
            <h3 className="text-xl mt-2">dEvelopurr</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              embrace the calls of the meow 
            </p>
          </div>
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a href="https://github.com/HolographicX" target="_blank" rel="noreferrer">
