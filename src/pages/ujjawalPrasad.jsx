...
export default function UjjawalPrasad() {
      ...
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">Ujjawal Prasad</h2>
            <h3 className="text-xl mt-2">Developer</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Computer Science student at Purdue University, from the Bay Area, California.
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a href="https://www.linkedin.com/in/ujjawal-prasad/" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.instagram.com/8wali8/" target="_blank" rel="noreferrer">
