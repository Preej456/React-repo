...
export default function SiyaJariwala() {
    ...
    <div className={`h-screen w-screen bg-black ${showOutline ? 'outline' : ''}`}>
      <div className="h-full w-full bg-black flex-col relative pt-10">
        ...
        <div className="w-full h-3/6 flex flex-col items-center mt-4 pt-12">
          {/* Profile Picture */}
          <img
            src="../siya_jariwala.jpeg" // Placeholder image
            alt="Profile Picture"
          ...
          <div className="text-center text-white mt-8">
            <h2 className="text-4xl font-bold">Siya Jariwala</h2>
            <h3 className="text-xl mt-2">Developer</h3>
            <p className="mt-4 text-gray-400 max-w-md">
              Computer science student at Purdue University, from Schaumburg Illinois.
          ...
          <div className="flex mt-8 gap-8 z-10">
            <a href="https://www.linkedin.com/in/siya-jariwala/" target="_blank" rel="noreferrer">
              <FaLinkedin className="text-white text-4xl hover:animate-pop cursor-pointer" />
            </a>
            <a href="https://github.com/siyasiyasiya" target="_blank" rel="noreferrer">
              <FaGithubSquare className="text-white text-4xl hover:animate-pop cursor-pointer" />
            </a>
            <a href="https://www.instagram.com/siya_jari/" target="_blank" rel="noreferrer">
